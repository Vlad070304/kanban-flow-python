...
class MainWindow(tk.Tk):
    ...
    def __init__(self, root: tk.Tk | None = None) -> None:
        ...
        self.kanban_board = KanbanBoard(self.root)  # type: ignore[arg-type]
    ...
    def _setup_menu(self) -> None:
        ...
        file_menu.add_command(
            label="New Task", command=self.kanban_board.entry_title.focus_set
        )
        file_menu.add_command(
            label="Export to CSV", command=self.kanban_board.export_csv_async
        )
        ...
        view_menu.add_command(
            label="Open Analytics & Logs", command=self.open_analytics
        )
    ...
    def open_analytics(self) -> None:
        ...
        AnalyticsWindow(self.root, self.kanban_board)  # type: ignore[arg-type]
